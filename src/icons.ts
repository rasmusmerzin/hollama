...
export const ICON_CHEVRON_DOWN = `<svg viewBox="0 -960 960 960"><path d="M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z"/></svg>`;
...
export const ICON_SPINNER = `<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="88" fill="none" stroke-width="24" stroke-dasharray="566" stroke-linecap="round"><animateTransform attributeName="transform" type="rotate" from="0 100 100" to="360 100 100" dur="0.5s" repeatCount="indefinite"/><animate attributeName="stroke-dashoffset" dur="1s" values="200;500;200" repeatCount="indefinite"/></circle></svg>`;
