...
export const ICON_SPINNER = `<svg viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="none" stroke-width="20" stroke-dasharray="566" stroke-linecap="round"><animateTransform attributeName="transform" type="rotate" from="0 100 100" to="360 100 100" dur="1s" repeatCount="indefinite"/><animate attributeName="stroke-dashoffset" dur="2s" values="200;500;200" repeatCount="indefinite"/></circle></svg>`;
